...
const Cart = () => {
  ...
  if (carts.length === 0) {
    return <div className=' h-[55vh] flex justify-center items-center text-4xl '>Giỏ hàng trống</div>
  }
    ...
    <div className="container mx-auto mt-10">
      <div className="flex shadow-md my-10">
                ...
                <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5" key={cart.id}>
                  <div className="flex w-2/5">
                    ...
                    <div className="flex flex-col justify-between ml-4 flex-grow">
                      ...
                      <div className="font-semibold hover:text-red-500 text-gray-500 text-xs cursor-pointer" onClick={() => removeProduct(cart?.id)}>Xóa</div>
                    </div>
                  </div>
        ...
        <div id="summary" className="w-1/4 px-8 py-10">
          ...
          <div>
            <label className="font-medium inline-block mb-3 text-sm uppercase">Vận Chuyển</label>
          ...
          <div className="py-10">
            ...
            <input type="text" id="promo" placeholder="Nhập mã của bạn" className="p-2 text-sm w-full" />
          </div>
          ...
          <div className="border-t mt-8">
            ...
            <button onClick={handleCheckout} className="bg-indigo-500 font-semibold hover:bg-indigo-600 py-3 text-sm text-white uppercase w-full">Thanh Toán</button>
          </div>
        </div>
