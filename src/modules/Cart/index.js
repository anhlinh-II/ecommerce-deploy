          ...
          {carts?.map(cart => (
            <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5" key={cart.id}>
              ...
              <span className="text-center w-1/5 font-semibold text-sm">
                {formatPrice(cart.price * 24000)} VNĐ
              </span>
              <span className="text-center w-1/5 font-semibold text-sm">
                {formatPrice(cart.price * 24000 * cart.quantity)} VNĐ
              </span>
            </div>
          ))}
        ...
        <div id="summary" className="w-1/4 px-8 py-10">
          ...
          <div className='mt-4'>
            ...
            <select className="block p-2 text-gray-600 w-full text-sm">
              <option>Giao hàng tiêu chuẩn - 200,000VNĐ</option>
            </select>
          </div>
          <div className="py-10">
          ...
          <div className="border-t mt-8">
            <div className="flex font-semibold justify-between py-6 text-sm uppercase">
              ...
              <span>{formatPrice(total + 200000)} VNĐ</span>
            </div>
            <button
